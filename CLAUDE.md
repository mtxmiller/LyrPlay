...
- **Current Version**: 1.7.7 build 13 in development (gapless refinements + stream info overlay + auto-reconnect)
...
- **Development Version**: 1.7.7 build 13 (gapless refinements, stream info overlay, auto-reconnect)
