...
- **Current Version**: 1.7.7 build 14 in development (gapless refinements + stream info overlay + auto-reconnect)
...
- **Development Version**: 1.7.7 build 14 (gapless refinements, stream info overlay, auto-reconnect)
